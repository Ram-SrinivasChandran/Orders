            ...
            <div class="product-content js-product-content">
              ...
              <div class="track-button-section">
                <a href="https://ram-srinivaschandran.github.io/Tracking/track.html">
                  <button class="track-button js-track-button" data-track-id="${display.id}" data-product-name="${display.productName}" data-product-image="${display.productImage}" data-product-cost="${display.productCost}" data-product-quantity="${display.quantity}">Track package</button>
                </a>
              </div>
            </div>`
            count++;
